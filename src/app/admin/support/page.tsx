          ...
          <Card>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                style={{ padding: '10px', border: '1px solid var(--border-color)', borderRadius: '8px', display: 'block', fontWeight: 600, fontSize: '13px', textDecoration: 'none', color: 'var(--text-primary)' }}
              >

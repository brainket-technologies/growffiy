...
export default function SupportPage() {
  ...
  return (
    <div className="support-page" style={{ display: 'flex', flexDirection: 'column', gap: '28px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <Card style={{ padding: '24px' }}>
        ...
        <div style={{ overflowX: 'auto', borderRadius: '12px', border: '1px solid var(--border-light)' }}>
          <table className="support-table" style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', minWidth: '850px' }}>
            <thead>
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          .support-page .filter-bar {
            flex-direction: column !important;
            align-items: stretch !important;
          }
          .support-page .filter-bar > div:first-child {
            min-width: 100% !important;
          }
          .support-page .filter-bar > div:last-child {
            width: 100% !important;
            flex-wrap: wrap !important;
          }
          .support-page .filter-bar select,
          .support-page .filter-bar input {
            width: 100% !important;
            box-sizing: border-box !important;
          }
          .support-page .filter-bar > div:last-child > div {
            width: 100% !important;
          }
        }
        ...
        @media (max-width: 1024px) {
          ...
          .support-page .support-table td {
            padding: 12px !important;
          }
          .support-page .support-table th:nth-child(3),
          .support-page .support-table td:nth-child(3) {
            display: none !important; /* Hide Date column on tablet */
          }
        }
        @media (max-width: 640px) {
          .support-page .support-table th:nth-child(2) span,
          .support-page .support-table td:nth-child(2) h4,
          .support-page .support-table td:nth-child(2) p {
            max-width: 180px !important;
          }
          .support-page .support-table td:first-child > div > div:last-child p:last-child {
            display: none !important; /* Hide user email/ID on mobile */
          }
        }
        ...
        /* ── Modal ── */
        @media (max-width: 640px) {
          .support-page .modal-actions {
            flex-direction: column !important;
          }
          .support-page .modal-actions button {
            width: 100% !important;
          }
        }
      `}</style>

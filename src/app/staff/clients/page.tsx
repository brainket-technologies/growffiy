...
export default function ClientsPage() {
  const canView = hasPerm('clients', 'view');
  const canCreate = hasPerm('clients', 'create');
  const canViewDetail = hasPerm('clients', 'viewDetail');
  const canEdit = hasPerm('clients', 'edit');
  const canDelete = hasPerm('clients', 'delete');
  const canExport = hasPerm('clients', 'export');
  const canKiteLogin = hasPerm('clients', 'kiteLogin');
...
@media (max-width: 640px) {
  .clients-page h1 { font-size: 20px !important; }
  .clients-page .stats-grid { grid-template-columns: 1fr 1fr !important; gap: 12px !important; }
  .clients-page .stats-grid .stat-card { padding: 14px !important; }
  .clients-page .stats-grid .stat-card .stat-value { font-size: 22px !important; }
  .clients-page .filter-bar { flex-direction: column !important; gap: 8px !important; padding: 12px !important; }
  .clients-page .filter-bar .search-box { width: 100% !important; }
  .clients-page .filter-bar .filter-row { width: 100% !important; flex-wrap: wrap !important; }
  .clients-page .filter-bar select { width: 100% !important; min-width: 0 !important; }
  .clients-page .table-responsive table th:nth-child(2),
  .clients-page .table-responsive table td:nth-child(2),
  .clients-page .table-responsive table th:nth-child(4),
  .clients-page .table-responsive table td:nth-child(4),
  .clients-page .table-responsive table th:nth-child(5),
  .clients-page .table-responsive table td:nth-child(5),
  .clients-page .table-responsive table th:nth-child(8),
  .clients-page .table-responsive table td:nth-child(8) { display: none !important; }
  .clients-page .header-actions { flex-direction: column !important; gap: 8px !important; }
  .clients-page .header-actions button { width: 100% !important; }
  .clients-page .pagination-container { flex-direction: column !important; gap: 12px !important; align-items: flex-start !important; }
  .clients-page table th, .clients-page table td { padding: 8px 6px !important; font-size: 12px !important; }
  .clients-page .modal-form { gap: 12px !important; }
  .clients-page .modal-form .form-grid { grid-template-columns: 1fr !important; gap: 12px !important; }
  .clients-page .modal-actions { flex-direction: column !important; gap: 8px !important; }
  .clients-page .modal-actions button { width: 100% !important; }
}
@media (min-width: 641px) and (max-width: 1024px) {
  .clients-page .stats-grid { gap: 14px !important; }
  .clients-page .stats-grid .stat-card { padding: 16px !important; }
  .clients-page .filter-bar select { min-width: 110px !important; }
  .clients-page .table-responsive table th:nth-child(5),
  .clients-page .table-responsive table td:nth-child(5) { display: none !important; }
  .clients-page table th, .clients-page table td { padding: 10px 8px !important; font-size: 13px !important; }
}
`;
  ...
  return (
    <div className="clients-page" style={{ display: 'flex', flexDirection: 'column', gap: '24px', maxWidth: '100%', overflowX: 'hidden' }}>
      {/* Responsive Styles */}
      <style>{styles}</style>

      {/* Header */}
      <div className="clients-page" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
      ...
      <div className="stats-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '20px' }}>
        <Card className="stat-card" style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: '8px', borderLeft: '4px solid var(--primary)' }}>
          ...
          <span className="stat-value" style={{ fontSize: '28px', fontWeight: 800, color: 'var(--text-primary)', fontFamily: 'var(--font-title)' }}>{totalCount}</span>
        </Card>
        <Card className="stat-card" style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: '8px', borderLeft: '4px solid var(--accent)' }}>
          ...
          <span className="stat-value" style={{ fontSize: '28px', fontWeight: 800, color: 'var(--accent)', fontFamily: 'var(--font-title)' }}>{activeCount}</span>
        </Card>
        <Card className="stat-card" style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: '8px', borderLeft: '4px solid var(--text-subtle)' }}>
          ...
          <span className="stat-value" style={{ fontSize: '28px', fontWeight: 800, color: 'var(--text-secondary)', fontFamily: 'var(--font-title)' }}>{inactiveCount}</span>
        </Card>
        <Card className="stat-card" style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: '8px', borderLeft: '4px solid #f59e0b' }}>
          ...
          <span className="stat-value" style={{ fontSize: '28px', fontWeight: 800, color: 'var(--warning)', fontFamily: 'var(--font-title)' }}>{connectedCount}</span>
        </Card>
      </div>
      ...
      <Card style={{ maxWidth: '100%', overflow: 'hidden' }}>
        ...
        <div className="filter-bar" style={{ 
          ...
          <div className="filter-row" style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '13px', color: 'var(--text-secondary)', whiteSpace: 'nowrap' }}>
                    ...
                    <tr key={client.id}>
                      ...
                      <td>
                        {canEdit ? (
                          ...
                          <span className={`badge ${isTrading ? 'badge-success' : 'badge-red'}`}>
                            {client.tradingStatus}
                          </span>
                        )}
                      </td>
                      <td style={{ textAlign: 'right', minWidth: '150px' }}>
                        <div style={{ display: 'flex', gap: '8px', justifyContent: 'flex-end', alignItems: 'center' }}>
                          {canKiteLogin && client.zerodhaApiKey ? (
                            <button
      ...
      <Modal isOpen={isAddModalOpen} onClose={() => setIsAddModalOpen(false)} title="Add New Client">
        <form className="modal-form" onSubmit={handleAddClient} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }} autoComplete="off">
          <div>

...
export default function ClientDetailsPage() {
  ...
  React.useEffect(() => {
    if (typeof window !== 'undefined' && !canViewDetail) {
    ...
    try {
      ...
      if (success) {
        setAlertModal({
          ...
          onConfirm: () => router.push('/staff/clients')
        });
      } else {
        setAlertModal({
          title: 'Error',
  ...
  if (error) {
    return (
      <div style={{ padding: '48px', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '20px' }}>
        ...
        <Button onClick={() => router.push('/staff/clients')} style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '28px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '13px', color: 'var(--text-muted)' }}>
          <span style={{ cursor: 'pointer' }} onClick={() => router.push('/staff/clients')}>Clients</span>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
            <Card style={{ display: 'flex', flexDirection: 'column', padding: '24px', alignItems: 'center', textAlign: 'center' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', width: '100%', textAlign: 'left' }}>
                ...
                <Button 
                  type="button" 
                  onClick={() => router.push(`/staff/clients/${id}`)}
                  style={{ 
                    marginTop: '12px',
                    width: '100%',
                    display: 'flex', 

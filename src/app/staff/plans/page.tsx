...
export default function AdminPlansPage() {
  const canView = hasPerm('plans', 'view');
  const canCreate = hasPerm('plans', 'create');
  const canEdit = hasPerm('plans', 'edit');
  const canDelete = hasPerm('plans', 'delete');
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', fontFamily: 'sans-serif', maxWidth: '100%', overflowX: 'hidden' }}>
      <style>{`
        ...
        @media (max-width: 640px) {
          .plans-header { flex-direction: column !important; align-items: flex-start !important; gap: 12px; }
          .plans-header h1 { font-size: 18px !important; }
          .plans-header p { font-size: 12px; }
          .plans-filters { flex-direction: column !important; align-items: stretch !important; }
          .plans-filters > div { width: 100% !important; min-width: 0 !important; }
          .plans-filters > select { width: 100% !important; min-width: 0 !important; }
        ...
        @media (min-width: 641px) and (max-width: 1024px) {
          .plans-filters { gap: 8px; }
          .plans-filters > div { min-width: 140px !important; }
          table th, table td { font-size: 12px !important; padding: 8px 6px !important; }
          table th:nth-child(4),

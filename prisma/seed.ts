...
async function main() {
  ...
  await prisma.strategy.upsert({
    ...
    update: {
      ...
      status: 'active',
      configJson: '{"basicInfo":{"name":"Pre-Open Momentum Breakout","status":"active","segment":"NSE F&O","exchange":"NSE","entryTime":"09:20:30","preSelectTime":"09:15:30","selectPosition":1,"tradeType":"Intraday","timeframe":"5m","checkIntervalSec":60,"description":"Pre-Open Momentum Breakout Strategy","exitTime":"15:15:00"},"stoploss":{"type":"Fixed %","orderType":"Market","fixedPercent":1,"fixedPoints":10,"trailingSL":-1,"riskPercent":1},"target":{"type":"Trailing Target","profitPercent":2,"riskRewardRatio":2,"partialExit":100,"trailingTarget":-1},"tradeAction":{"action":"Long","orderType":"SL-Market","bufferPercent":0.1,"candlePriceType":"high"},"riskManagement":{"riskPerTrade":1,"killSwitch":false,"maxOpenPositions":3,"maxDailyLoss":-1,"maxDailyProfit":-1,"capitalAllocation":-1,"misMarginRate":-1},"conditions":[{"value":"-10","logical":"AND","operator":">","indicator":"Pre Open Change %"}]}'
    },
    create: {
